...
//		System.out.println("******Destination in ARP:" + ApplicationLayer.byte2IP(dest_ip_address));
...
//						System.out.println("DEST MAC ADDRESS:" + dest_mac_address);
...
//		System.arraycopy(dest_ip_address, 0, dst_ip, 0, dst_ip.length);
//		System.out.println("PREVIOUS");
//		printNATTable();
		if(ApplicationLayer.byte2IP(dest_ip_address).equals("192.168.0.2")) {
			
		}else {
			dest_ip_address[0]=(byte)0xA8;
			dest_ip_address[1]=(byte)0xBC;
			dest_ip_address[2]=(byte)0x81;
			dest_ip_address[3]=(byte)0x01;
		}
